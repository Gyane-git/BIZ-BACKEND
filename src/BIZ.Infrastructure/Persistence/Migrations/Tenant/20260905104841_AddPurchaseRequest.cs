        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredByDate = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_FiscalYearPeriods_FiscalYearPeriodId",
                        column: x => x.FiscalYearPeriodId,
                        principalTable: "FiscalYearPeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_FiscalYears_FiscalYearId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequestLines_PurchaseRequestId_LineNumber",
                table: "PurchaseRequestLines",
                columns: new[] { "PurchaseRequestId", "LineNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_FiscalYearId",
                table: "PurchaseRequests",
                column: "FiscalYearId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_FiscalYearPeriodId",
                table: "PurchaseRequests",
