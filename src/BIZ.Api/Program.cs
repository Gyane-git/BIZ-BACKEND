...
builder.Services.AddScoped<IProductSchemeService, ProductSchemeService>();
builder.Services.AddScoped<IProductSchemeLineService, ProductSchemeLineService>();
builder.Services.AddScoped<IProductCompositionService, ProductCompositionService>();
builder.Services.AddScoped<IProductCompositionLineService, ProductCompositionLineService>();
builder.Services.AddScoped<IValueAddedListService, ValueAddedListService>();
...
builder.Services.AddScoped<IPurchaseInvoiceLineService,PurchaseInvoiceLineService>();
builder.Services.AddScoped<IPurchaseReturnService,PurchaseReturnService>();
builder.Services.AddScoped<IPurchaseReturnLineService,PurchaseReturnLineService>();
builder.Services.AddScoped<IPurchasePaymentService,PurchasePaymentService>();
builder.Services.AddScoped< IPurchasePaymentAllocationService,PurchasePaymentAllocationService>();
...
builder.Services.AddScoped<IStockTransferLineService,StockTransferLineService>();
builder.Services.AddScoped<IStockCountService, StockCountService>();
builder.Services.AddScoped<IStockCountLineService, StockCountLineService>();
builder.Services.AddScoped<IStockOpeningService, StockOpeningService>();
builder.Services.AddScoped<IStockOpeningLineService, StockOpeningLineService>();
